...
/* CNNの基本構造(骨組みのみ)を示します						*/
/* 使い方							*/
/* /home/fandm/ML02/sin/cp.c  ./simplecnn < data1.txt		*/
/****************************************************************/
...
#define MAXINPUTNO 3			/* 学習データの最大個数 */
...
{
int i = 0, j = 0, k = 0;			/* 繰り返しの制御 */

   /* データの表示 */
   for(i = 0; i < n_of_e; ++i)
   {
   		printf("N=%d catagory=%d\n", i, t[i]);
